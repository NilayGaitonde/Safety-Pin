...
class GeoCorridor {
  ...
  factory GeoCorridor.withRadius(List<GeoCoordinates> polyline, int radiusInMeters) => $prototype.withRadius(polyline, radiusInMeters);
...
class GeoCorridor$Impl {
  GeoCorridor withRadius(List<GeoCoordinates> polyline, int radiusInMeters) {
    final _withRadiusFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Pointer<Void>, Int32), Pointer<Void> Function(int, Pointer<Void>, int)>('here_sdk_sdk_core_GeoCorridor_makeDeprecated__ListOf_sdk_core_GeoCoordinates_Int'));
