...
class EVChargingStation {
  ...
  EVChargingStation(this.supplierName, this.connectorTypeName, this.connectorTypeId, this.powerFeedTypeName, this.powerFeedTypeId, this.maxPowerInKilowatts, this.connectorCount, this.chargingMode, this.voltageRangeInVolts, this.currentRangeInAmperes, this.phaseCount);
  @override
