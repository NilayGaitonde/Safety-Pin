...
abstract class TransitRoutingEngine {
  ...
  ///
  void calculateRoute(TransitWaypoint startingPoint, TransitWaypoint destination, TransitRouteOptions routeOptions, CalculateRouteCallback callback);
...
class TransitRoutingEngine$Impl extends __lib.NativeBase implements TransitRoutingEngine {
  ...
  void calculateRoute(TransitWaypoint startingPoint, TransitWaypoint destination, TransitRouteOptions routeOptions, CalculateRouteCallback callback) {
    ...
    _calculateRouteFfi(_handle, __lib.LibraryContext.isolateId, _startingPointHandle, _destinationHandle, _routeOptionsHandle, _callbackHandle);
